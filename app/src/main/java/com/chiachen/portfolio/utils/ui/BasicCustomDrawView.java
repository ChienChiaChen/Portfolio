    ...
    protected void setPaint(int color, float textSize, float strokeWidth) {
        ...
        switch (color) {
            ...
            case BLACK:
                ...
                typeface = TypefaceManager.getTypeface(getContext(), TypefaceManager.GOTHAM_RND_BOLD);
                break;
            ...
            case CHART_DARK_GREY:
                ...
                typeface = TypefaceManager.getTypeface(getContext(), TypefaceManager.GOTHAM_RND_MEDIUM);
                break;
