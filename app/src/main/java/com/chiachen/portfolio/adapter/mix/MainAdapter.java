package com.chiachen.portfolio.adapter.mix;
...
import com.chiachen.portfolio.activity.RecyclerMixViewActivity;
...
public class MainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void verticalView(VerticalViewHolder holder) {
        VerticalAdapter adapter1 = new VerticalAdapter(RecyclerMixViewActivity.getVerticalData());
        holder.recyclerView.setLayoutManager(new LinearLayoutManager(context));
        holder.recyclerView.setAdapter(adapter1);
    }

    private void horizontalView(HorizontalViewHolder holder) {
        HorizontalAdapter adapter = new HorizontalAdapter(RecyclerMixViewActivity.getHorizontalData());
